...
![RAG Search Architecture — จากคำถามสู่คำตอบใน 0.3 วินาที](/static/rag-search-2456-documents-03-seconds/img-1.svg)
...
![Hybrid Search — BM25 + Vector + RRF Fusion ทำงานอย่างไร](/static/rag-search-2456-documents-03-seconds/img-2.svg)

---

## ตัวเลขจริงจากระบบ production

![Production RAG System — metrics จริงจาก 2,456 documents](/static/rag-search-2456-documents-03-seconds/img-3.svg)
...
![Incremental indexing — index เฉพาะไฟล์ที่เปลี่ยน ไม่ re-index ทั้งหมด](/static/rag-search-2456-documents-03-seconds/img-4.svg)

---

## สิ่งที่ควรรู้ก่อนสร้าง

![RAG Production Pitfalls — สิ่งที่ต้องระวังก่อน deploy](/static/rag-search-2456-documents-03-seconds/img-5.svg)
