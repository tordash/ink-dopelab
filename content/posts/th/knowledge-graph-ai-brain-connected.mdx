...
<img src="/diagrams/knowledge-graph/kg-before-after.svg" alt="Before vs After — จาก 450 ไฟล์กระจัดกระจาย สู่ Knowledge Graph ที่เชื่อมโยงทุกอย่าง" width="800" />
...
<img src="/diagrams/knowledge-graph/kg-overview.svg" alt="Knowledge Graph Overview — 332 nodes, 1,602 edges เชื่อมโยง Clients, Technical, Sessions" width="800" />

---

## วิธีสร้าง Knowledge Graph — 3 ขั้นตอน

<img src="/diagrams/knowledge-graph/kg-3-steps.svg" alt="3 ขั้นตอนสร้าง Knowledge Graph — Extract wikilinks, Embed to ChromaDB, Graph-enhanced Search" width="800" />
...
<img src="/diagrams/knowledge-graph/kg-architecture.svg" alt="Architecture — Data flow จาก Obsidian brain/ ผ่าน Processing สู่ ChromaDB และ rag CLI" width="800" />
...
<img src="/diagrams/knowledge-graph/kg-search-comparison.svg" alt="Search Comparison — grep (2 results) vs Vector (3 results) vs Graph-enhanced (5 results)" width="800" />
