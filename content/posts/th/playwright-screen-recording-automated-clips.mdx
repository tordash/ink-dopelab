...
![Playwright browser automation recording](/static/playwright-recording/demo-problem.svg)
...
![Automated demo recording for client presentation](/static/playwright-recording/client-demo.svg)
...
![Playwright MCP server for AI agents](/static/playwright-recording/mcp-server.svg)
