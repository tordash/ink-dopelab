...
![Playwright browser automation recording](/static/playwright-recording/demo-problem.gif)
...
![Playwright video recording workflow diagram](/static/playwright-recording/workflow-diagram.svg)
...
![Automated demo recording for client presentation](/static/playwright-recording/client-demo.gif)
...
![Screen recording pipeline for content creation](/static/playwright-recording/content-pipeline.svg)
...
![FFmpeg conversion from webm to mp4](/static/playwright-recording/ffmpeg-conversion.svg)
...
![Playwright MCP server for AI agents](/static/playwright-recording/mcp-server.gif)
